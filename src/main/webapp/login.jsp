...
<div class="info_form signup-box">
    ...
    <form action="<%= request.getContextPath()%>/router-servlet" class="material-signup-form" method="get">
        <div class="form-group">
            <%--@declare id="email"--%><label for="email">Email
            <input type="email" class="form-control" name="email" placeholder="Enter your email" required>
        </label>
        </div>

        <div class="form-group">
            <%--@declare id="Password"--%><label for="Password">Password
...
<%
    ...
    String log = (String)request.getAttribute("logdata");
    if(log!=null)
    {
        out.println("<p style='color:green;text-align:center'>"+log+"</p>");
    }
